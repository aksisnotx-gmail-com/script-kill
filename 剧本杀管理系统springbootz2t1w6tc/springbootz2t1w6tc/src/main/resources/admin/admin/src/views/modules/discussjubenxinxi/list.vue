...
export default {
  ...
  methods: {
	...
	this.$router.push({path:'/discussdiscussjubenxinxi',query:{refid:id}});
    },
    // 下载
    download(file){
      window.open(`${file}`)
