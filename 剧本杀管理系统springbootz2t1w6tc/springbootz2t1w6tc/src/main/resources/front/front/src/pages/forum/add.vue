<template>
  <div :style='{"width":"100%","padding":"80px 10%","margin":"10px auto","position":"relative","background":"#F6F6F6"}'>
    <div class="section-title" :style='{"margin":"10px 0","color":"#000","textAlign":"center","background":"rgba(95, 227, 235, 0.20)","width":"100%","fontSize":"20px","lineHeight":"54px","fontWeight":"bold","order":"1"}'>游戏论坛</div>
