<template>
	...
	<div class="container" :style='{"minHeight":"100vh","width":"100%","alignItems":"center","background":"url(http://codegen.caihongy.cn/20240201/16ba3d6813174f3ca7315ed484ce0d90.png) center center/100% 100% no-repeat","justifyContent":"center","display":"flex"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"40px 20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"0","borderRadius":"30px","flexWrap":"wrap","background":"#fff","display":"flex","width":"44%","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"margin":"0 0 10px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"30px","textShadow":"none","fontWeight":"bold"}'> 剧本杀管理系统注册</p></div>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="yonghuzhanghao">
				<div v-if="true" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","background":"none"}' :class="changeRules('yonghuzhanghao')?'required':''">用户账号：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="yonghuxingming">
				<div v-if="true" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","background":"none"}' :class="changeRules('yonghuxingming')?'required':''">用户姓名：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="nianling">
				<div v-if="true" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","background":"none"}' :class="changeRules('nianling')?'required':''">年龄：</div>
