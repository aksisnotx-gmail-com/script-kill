<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="剧本名称" prop="jubenmingcheng">
					<el-input v-model="ruleForm.jubenmingcheng" placeholder="剧本名称" clearable  :readonly="ro.jubenmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="剧本名称" prop="jubenmingcheng">
					<el-input v-model="ruleForm.jubenmingcheng" placeholder="剧本名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="游戏角色" prop="youxijiaose">
					<el-input v-model="ruleForm.youxijiaose" placeholder="游戏角色" clearable  :readonly="ro.youxijiaose"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="游戏角色" prop="youxijiaose">
					<el-input v-model="ruleForm.youxijiaose" placeholder="游戏角色" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="报名备注" prop="baomingbeizhu">
					<el-input v-model="ruleForm.baomingbeizhu" placeholder="报名备注" clearable  :readonly="ro.baomingbeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="报名备注" prop="baomingbeizhu">
